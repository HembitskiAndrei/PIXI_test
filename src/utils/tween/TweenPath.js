...
export class TweenPath extends Graphics{
    constructor(){
        super()
        this._closed = false;
    ...
    moveTo(x, y){
        super.moveTo.call(this, x,y);
        this.dirty = true;
        return this;
    }

    lineTo(x, y){
        super.lineTo.call(this, x,y);
        this.dirty = true;
        return this;
    }

    bezierCurveTo(cpX, cpY, cpX2, cpY2, toX, toY){
        super.bezierCurveTo.call(this, cpX, cpY, cpX2, cpY2, toX, toY);
        this.dirty = true;
        return this;
    }

    quadraticCurveTo(cpX, cpY, toX, toY){
        super.quadraticCurveTo.call(this, cpX, cpY, toX, toY);
        this.dirty = true;
        return this;
    }

    arcTo(x1, y1, x2, y2, radius){
        super.arcTo.call(this, x1, y1, x2, y2, radius);
        this.dirty = true;
        return this;
    }

    arc(cx, cy, radius, startAngle, endAngle, anticlockwise){
        super.arc.call(this, cx, cy, radius, startAngle, endAngle, anticlockwise);
        this.dirty = true;
        return this;
    }

    drawShape(shape){
        super.drawShape.call(this, shape);
        this.dirty = true;
        return this;
    }
